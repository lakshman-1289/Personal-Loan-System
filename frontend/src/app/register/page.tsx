  ...
  return (
    <div className="max-w-md mx-auto my-12 bg-slate-900 border border-slate-800 p-8 rounded-2xl shadow-2xl backdrop-blur-md relative overflow-hidden">
      ...
      <div className="mb-8 text-center space-y-2">
        ...
        <p className="text-slate-400 text-xs">Begin your digital personal loan journey</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-2">
          ...
          />
          {fieldErrors.phone && <p className="text-rose-400 text-[10px]">{fieldErrors.phone}</p>}
        </div>
      ...
      <div className="mt-8 text-center text-xs text-slate-400">
        ...
        <Link href="/login" className="font-semibold text-indigo-400 hover:text-indigo-300 hover:underline transition">
          Sign In
        </Link>
      </div>
    </div>
