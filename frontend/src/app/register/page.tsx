  ...
  return (
    <div className="max-w-md mx-auto my-12 bg-white border border-[#E4EAF0] p-8 rounded-2xl shadow-lg relative overflow-hidden text-neutral-text">
      ...
      <div className="mb-8 text-center space-y-2">
        <h2 className="text-3xl font-extrabold text-neutral-text tracking-tight">Create Account</h2>
        <p className="text-neutral-secondary text-xs">Begin your digital personal loan journey</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-2">
          <label className="block text-xs font-semibold uppercase tracking-wider text-neutral-secondary">Phone Number</label>
          <input
            type="tel"
            required
            value={phone}
          ...
          />
          {fieldErrors.phone && <p className="text-rose-500 text-[10px]">{fieldErrors.phone}</p>}
        </div>
      ...
      <div className="mt-8 text-center text-xs text-neutral-secondary">
        ...
        <Link href="/login" className="font-semibold text-brand-blue hover:text-brand-dark-blue hover:underline transition">
          Sign In
        </Link>
      </div>
    </div>
