  ...
  return (
    <div className="w-full max-w-2xl mx-auto space-y-8 py-6 text-neutral-text">
      ...
      <div className="flex items-center justify-between text-xs text-neutral-secondary bg-brand-light-blue border border-[#E4EAF0] rounded-full px-6 py-3">
        ...
        <ChevronRightIcon className="h-3 w-3" />
        <span className="text-brand-blue font-bold">5. Sign Declarations</span>
      </div>
      ...
      <div className="bg-white border border-[#E4EAF0] p-8 rounded-2xl shadow-lg">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-2xl font-bold text-neutral-text tracking-tight">Legal Declarations</h2>
            <p className="text-neutral-secondary text-xs">Review carefully and accept consents to complete onboarding.</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            ...
            <label className="flex items-start gap-4 p-4 bg-white border border-[#E4EAF0] rounded-xl hover:border-brand-blue transition cursor-pointer select-none">
              <input
                type="checkbox"
                checked={acceptedPrivacyPolicy}
                onChange={(e) => setAcceptedPrivacyPolicy(e.target.checked)}
                className="mt-1 h-4 w-4 rounded border-[#E4EAF0] text-brand-green focus:ring-brand-green cursor-pointer accent-brand-green"
              />
              <div className="space-y-0.5">
                <span className="text-xs font-bold text-neutral-text block">Accept Privacy Policy</span>
                <span className="text-[10px] text-neutral-secondary leading-relaxed block">
            ...
            <label className="flex items-start gap-4 p-4 bg-white border border-[#E4EAF0] rounded-xl hover:border-brand-blue transition cursor-pointer select-none">
              ...
              />
              <div className="space-y-0.5">
                <span className="text-xs font-bold text-neutral-text block">Accept Terms & Lending Conditions</span>
                <span className="text-[10px] text-neutral-secondary leading-relaxed block">
            ...
            <label className="flex items-start gap-4 p-4 bg-white border border-[#E4EAF0] rounded-xl hover:border-brand-blue transition cursor-pointer select-none">
              ...
              />
              <div className="space-y-0.5">
                <span className="text-xs font-bold text-neutral-text block">Authorize Credit Bureau Inquiries (CRIB)</span>
                <span className="text-[10px] text-neutral-secondary leading-relaxed block">
